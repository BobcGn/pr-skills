...
description: 校验 Commit Message 是否符合 Conventional Commits（Angular 规范），自动检测类型/scope/breaking change 并基于 diff 重写。
trigger: PR 提交阶段（pre-commit 或 squash merge 前）
---
